...
export default function CalculationsError({ error, reset }: ErrorProps) {
  useEffect(() => {
    ...
    <div className="flex items-center justify-center min-h-[60vh] px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">
          Kunne ikke indlæse kalkulationer
        </h1>
        <p className="text-gray-600 mb-6">
          Der opstod en fejl ved indlæsning af kalkulationsdata. Prøv at genindlæse siden.
        </p>
        {error.digest && (
