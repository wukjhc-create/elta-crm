...
export default function MailError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error('Mail module error:', error)
  }, [error])
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Mail-modulet fejlede</h1>
        <p className="text-gray-600 mb-6">
          Der opstod en fejl i mail-indbakken. Det kan skyldes en midlertidig forbindelsesfejl til Microsoft Graph.
        </p>
        {error.digest && (
