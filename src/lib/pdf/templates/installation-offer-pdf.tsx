...
interface InstallationOfferPdfProps {
...
export function InstallationOfferPdfDocument({
  quote,
  quoteReference,
  validUntil,
  financials,
  companySettings,
}: InstallationOfferPdfProps) {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            <Text style={styles.title}>MONTERINGSTILBUD</Text>
        ...
        <View style={styles.section}>
          ...
          {quote.description && (
            <View style={styles.scopeBox}>
              <Text style={styles.scopeTitle}>Opgavebeskrivelse</Text>
